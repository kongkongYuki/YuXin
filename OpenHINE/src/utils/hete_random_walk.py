                ...
                for j in range(0, numwalks):
                    ...
                    while k < walklength:
                        if (current_node[0] == mg_type[0]):
                            ...
                            l1 = len(relation2[current_node[1:]]) if current_node[1:] in relation2.keys() else 0
                            l2 = len(relation3[current_node[1:]]) if current_node[1:] in relation3.keys() else 0
                            l3 = len(relation5[current_node[1:]]) if current_node[1:] in relation5.keys() else 0
